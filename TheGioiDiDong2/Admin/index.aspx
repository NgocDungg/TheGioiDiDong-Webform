<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TheGioiDiDong2.Admin.index" %>
                ...
                <div class="dropdown-divider"></div>
                  ...
                  <svg class="icon me-2">
                    <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                      ...
                      <asp:LinkButton ID="DangXuat" runat="server" CssClass="dropdown-item" OnClick="DangXuat_Click">
                          <svg class="icon me-2">
                            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                          </svg> Logout
                      </asp:LinkButton>
