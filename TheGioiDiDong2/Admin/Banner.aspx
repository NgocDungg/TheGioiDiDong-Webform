<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Banner.aspx.cs" Inherits="TheGioiDiDong2.Admin.Banner" %>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Quản lý banner</span></li>
            </ol>
          </nav>
        </div>
      </header>
      <div class="body flex-grow-1 px-3">
        <div class="container-lg">
           <div class="card mb-4" style="display:flex; justify-content:center; align-items:center">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" PageSize="4" Width="700px" CellPadding="4" EnableViewState="false" 
                DataKeyNames="ID" ForeColor="Black" GridLines="Both" 
                OnRowDeleting="GridView1_RowDeleting" 
                OnRowEditing="GridView1_RowEditing" 
                OnPageIndexChanging="GridView1_PageIndexChanging"
                 AllowPaging="true" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin:60px 0px 10px 0px "
                >
               ...
               <a href="../QuanLy/BannerSlideThem.aspx"     
                  style="border:1px solid;text-decoration:none; color:black; padding:5px 30px; margin-bottom:30px ;background-color:#efefef">Thêm banner hình ảnh</a>
          </div> 
        </div>
      </div>
      <footer class="footer">
