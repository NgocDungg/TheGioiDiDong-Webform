<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KhachHang.aspx.cs" Inherits="TheGioiDiDong2.Admin.KhachHang1" %>
            ...
            <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-menu-end pt-0">
                ...
                <div class="dropdown-divider"></div><a class="dropdown-item" href="../default.aspx">
                  ...
                  <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnThem_Click" CssClass="dropdown-item"> 
                  <svg class="icon me-2">
                    <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-account-logout"></use>
                  </svg> Logout</asp:LinkButton>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Quản lý khách hàng</span></li>
            </ol>
          </nav>
        </div>
      </header>
        ...
        <div class="container-lg">
            ...
            <asp:GridView ID="GridView1" AutoGenerateColumns="false" Width="1100px" Height="500px" PageSize="4" runat="server"
                ...
                OnPageIndexChanging="GridView1_PageIndexChanging"
                 AllowPaging="true" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin:32px 0px 10px 0px" >
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tài khoản" HeaderStyle-HorizontalAlign="left">
                        <ItemTemplate>
                            <%#Eval("TaiKhoan") %>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Mật khẩu" HeaderStyle-HorizontalAlign="left">
                        <ItemTemplate>
                            <%#Eval("MatKhau") %>
                        </ItemTemplate>
                ...
                <a href="../DangKy.aspx"     
                  style="margin-bottom:20px ;border:1px solid;text-decoration:none; color:black; padding:5px 30px; background-color:#efefef">Thêm người dùng
