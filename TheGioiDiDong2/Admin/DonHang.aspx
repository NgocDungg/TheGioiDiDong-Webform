<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonHang.aspx.cs" Inherits="TheGioiDiDong2.Admin.DonHang" %>
        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Quản lý đơn hàng</span></li>
            </ol>
          </nav>
        </div>
      </header>
        ...
        <div class="container-lg">
          <div class="card mb-4" style="display:flex; justify-content:center; align-items:center">
            <asp:GridView ID="GridView1" AutoGenerateColumns="False" Width="1100px" Height="500px" PageSize="4" runat="server"
                CellPadding="4" EnableViewState="False" DataKeyNames="IDCart" ForeColor="Black"
                OnRowDeleting="GridView1_RowDeleting" 
                OnRowEditing="GridView1_RowEditing" 
                OnPageIndexChanging="GridView1_PageIndexChanging"
                 AllowPaging="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="margin:40px 0px"  >
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Họ và tên" HeaderStyle-HorizontalAlign="left">
                        <ItemTemplate>
                            <%#Eval("FullName") %>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Tên sản phẩm" HeaderStyle-HorizontalAlign="left">
                        <ItemTemplate>
                            <%#Eval("TenSP") %>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Giá bán" HeaderStyle-HorizontalAlign="left">
                        <ItemTemplate>
                            <%#Eval("GiaBan") %>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Ảnh sản phẩm" HeaderStyle-HorizontalAlign="left">
                        <ItemTemplate>
                    ...
                    <asp:CommandField ControlStyle-CssClass="input_delete" DeleteText="Duyệt" ShowDeleteButton="True" ButtonType="Button" HeaderText="Thao tác" HeaderStyle-HorizontalAlign="Left">
